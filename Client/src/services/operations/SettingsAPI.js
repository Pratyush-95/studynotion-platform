...
export function requestAccountDeletion(token) {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("REQUEST ACCOUNT DELETION RESPONSE:", response);
...
export function cancelAccountDeletion(token) {
  return async () => {
    const toastId = toast.loading("Cancelling deletion...");
    ...
    try {
      ...
      console.log("CANCEL ACCOUNT DELETION RESPONSE:", response);
