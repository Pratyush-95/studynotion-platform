...
function CourseDetails() {
  ...
  const {
    ...
    ratingAndReviews = [],
    instructor = {},
    studentsEnrolled: enrolledStudentsFromResponse = [],
    studentsEnroled = [],
    createdAt,
  } = response.data?.courseDetails || {}

  const studentsEnrolled =
    Array.isArray(enrolledStudentsFromResponse) && enrolledStudentsFromResponse.length
      ? enrolledStudentsFromResponse
      : Array.isArray(studentsEnroled)
      ? studentsEnroled
      : []
          ...
          <div className="max-w-[830px] ">
            ...
            <div className="mb-12 py-4">
              ...
              <p className="text-richblack-50">
                {instructor?.additionalDetails?.about || "No description available"}
              </p>
            </div>
          </div>
        </div>
