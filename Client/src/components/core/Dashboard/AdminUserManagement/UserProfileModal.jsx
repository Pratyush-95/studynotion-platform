const UserProfileModal = ({ user, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-6">
      <div className="max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-xl border border-richblack-700 bg-richblack-900/95 p-8 shadow-[0_40px_80px_rgba(0,0,0,0.45)]">
